...
from pysyncobj.batteries import ReplLockManager, SyncObjConsumer, replicated
...
# syncObjConf.journalFile='0.log'
syncObjConf.password = 'S3kr1t'
syncObj = SyncObj('127.0.0.1:4322', ['127.0.0.1:4323', '127.0.0.1:4324'], consumers=[
