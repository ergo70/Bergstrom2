...
connect_string = 'host=127.0.0.1 port=5433 user=bergstrom dbname=postgres sslmode=verify-full sslkey=c:/Devel/Bergstrom2/Bergstrom.key sslcert=c:/Devel/Bergstrom2/Bergstrom.cert sslrootcert=c:/Devel/Bergstrom2/root.cert'
...
#syncObjConf.journalFile='1.log'
syncObjConf.password='S3kr1t' 
syncObj = SyncObj('127.0.0.1:4323', ['127.0.0.1:4322', '127.0.0.1:4324'], consumers=[
