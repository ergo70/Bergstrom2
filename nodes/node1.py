...
connect_string = 'host=127.0.0.1 port=5433 user=bergstrom dbname=postgres sslmode=verify-full sslkey=Bergstrom.key sslcert=Bergstrom.cert sslrootcert=root.cert'
